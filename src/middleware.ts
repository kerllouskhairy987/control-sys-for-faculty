...
export function middleware(request: NextRequest) {
    ...
    const isProfessor = hasRole(decodedToken.roles, Roles.Professor) || hasRole(decodedToken.roles, Roles.Teacher);
    ...
    if (isProfessorAreaUser) {
        ...
        const advisorOnlyPath = pathname.startsWith('/professor/students') || pathname.startsWith('/professor/pending');
